...
export default function Reservation() {
  ...
  const handleSubmit = async (e) => {
    ...
    const reservationData = {
      seatingType: formData.get("seating"),
      date: formData.get("date"),
      numberOfDiners: formData.get("diners"),
      ...
      specialRequests: formData.get("message"),
  ...
  return (
    <div className="py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="mx-auto mt-14 sm:mt-16 rounded-md bg-[#495e57] text-white shadow-xl p-6">
                      ...
                      <Listbox.Options className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white p-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
                        {occasions.map((occasion, occasionIdx) => (
                          <Listbox.Option
                            key={occasionIdx}
                            className={({ active }) =>
                              `relative cursor-default text-black select-none py-3 pl-10 pr-4 ${active ? "bg-gray-100" : ""
                              }`
                            }
                            value={occasion}
                          >
